...
const vmdInputBox = "font-size:16px; width:179px; font-weight:500; justify:left; \
  background-color:#FFCCBC; line-height:30px; padding-left:2px; padding-right:2px;text-align:right;\
  margin-bottom:2px;"
